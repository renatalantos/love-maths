...
function checkAnswer() {
    ...
    if (isCorrect) {
        ...
        alert(`Haaa-haw! Loooooooooser!!! The correct answer was ${calculatedAnswer}, sucker! :DDD`);
...
/**
 * Get the operands(the numbers) and the operator(plus, minus, etc) directly from the DOM 
